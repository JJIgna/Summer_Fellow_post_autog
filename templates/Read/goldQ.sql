/*
 * This is the example gold file for query HW using .sql file.
 ...
 * BE SURE TO STATE THIS EXPLICITLY WHEN ASSIGNING THE HOMEWORK
 * You could give a template file for with the homework with all the smart comments in place with
 *  numbers telling students where to place each query.
 */
